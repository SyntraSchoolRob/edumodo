    ...
    <div class="col-8">
        ...
        <div class="d-md-flex">
            <div class="form-group">
                ...
                {!! Form::text('first_name', null,['class'=>'form-control rounded-pill'] ) !!}
            </div>
            <div class="form-group ml-md-5">
                {!! Form::label('last_name', 'Last name:') !!}
                {!! Form::text('last_name', null,['class'=>'form-control rounded-pill']) !!}
            </div>
        </div>
        <div class="form-group">
            {!! Form::label('email', 'E-mail:') !!}
            {!! Form::text('email', null,['class'=>'form-control rounded-pill']) !!}
        </div>
        <div class="form-group">
